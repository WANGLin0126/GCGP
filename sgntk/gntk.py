...
from utils import dense_adj_to_sparse


class GraphNeuralTangentKernel(nn.Module):
    def __init__(self,  K=2, L=2, scale='add' ):
        super(GraphNeuralTangentKernel, self).__init__()
        self.K = K
        self.L = L
        self.scale  = scale
    ...
    def nodes_gram(self, g1, g2, E1, E2):
        ...
        if not E1.is_sparse:
            E1 = dense_adj_to_sparse(E1)
        
        if not E2.is_sparse:
            E2 = dense_adj_to_sparse(E2)
