...
from torch_geometric.nn import SAGEConv, SGConv, APPNP, ChebConv, GCNConv, GATConv, GINConv
...
class GIN(nn.Module):
    def __init__(self, in_features, hidden_size, num_classes):
        ...
        self.conv1 = GINConv(nn.Linear(in_features, hidden_size))
        self.conv2 = GINConv(nn.Linear(hidden_size, num_classes))
